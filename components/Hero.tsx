...
const Hero: React.FC = () => {
  ...
  const videoSources = [
    "https://assets.mixkit.co/videos/preview/mixkit-playing-basketball-at-an-outdoor-court-2423-large.mp4",
    "https://assets.mixkit.co/videos/preview/mixkit-family-watching-a-movie-at-home-4134-large.mp4",
    "https://assets.mixkit.co/videos/preview/mixkit-busy-city-street-hyperlapse-at-night-4019-large.mp4"
  ];
